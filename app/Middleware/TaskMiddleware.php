<?php
  ...
  class TaskMiddleware extends Middleware
  {
    ...
    private function _proceed(Request $request)
    {
      ...
      if ($o && isset($o->task)) {
        return $request->withAttribute('task', $user->getJournal()->getGoals()->matching(Criteria::create()->where(Criteria::expr()->eq('id', $o->task)))->first());
      }
    ...
    private function _validate(Request $request)
    {
      ...
      if (isset($o) && $this->check_fields($o)) {
        ...
        return $request->withAttribute('task', $o);
      }
      throw new Exception(Strings::$MISSING_FIELDS[0]);
    }
