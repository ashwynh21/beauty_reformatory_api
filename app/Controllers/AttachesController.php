    ...
    public function fetch(Request $request, Response $response)
    {
      ...
      try {
        ...
        if ($attaches) {
           ...
           * Check file type here
           */
          $a = $this->manager->getRepository(Attaches::class)
            ->findOneBy(array('id' => $attaches->getId()));
          if ($a) {
            $file = base64_decode(stream_get_contents($a->getAttachment()));
             ...
             */
            return $response->withHeader('Content-Type', $a->getType())->write($file);
